...
import org.clxmm.service.ucenter.util.UcenterProperties;
...
public class ApiWxController {
    ...
    public String genQrConnect(HttpSession session) {
        ...
        try {
            ...
            throw new ClxmmException(ResultCodeEnum.URL_ENCODE_ERROR);
        }
    ...
    public String callback(String code, String state, HttpSession session) {
        ...
        if (StringUtils.isEmpty(code) || StringUtils.isEmpty(state)) {
            log.error("非法回掉请求");
            throw new ClxmmException(ResultCodeEnum.ILLEGAL_CALLBACK_REQUEST_ERROR);
        }
        ...
        try {
            ...
            throw new ClxmmException(ResultCodeEnum.FETCH_ACCESSTOKEN_FAILD);
        }
